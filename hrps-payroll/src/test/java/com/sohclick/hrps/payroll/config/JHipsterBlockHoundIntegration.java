package com.sohclick.hrps.payroll.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.sohclick.hrps.payroll.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.sohclick.hrps.payroll.security.DomainUserDetailsService", "createSpringSecurityUser");
