package com.sohclick.hrps.hr.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.sohclick.hrps.hr.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.sohclick.hrps.hr.security.DomainUserDetailsService", "createSpringSecurityUser");
