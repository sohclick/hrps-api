package com.sohclick.hrps.gateway.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.sohclick.hrps.gateway.service.EmailAlreadyUsedException ||
            ex instanceof com.sohclick.hrps.gateway.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.sohclick.hrps.gateway.service.InvalidPasswordException
