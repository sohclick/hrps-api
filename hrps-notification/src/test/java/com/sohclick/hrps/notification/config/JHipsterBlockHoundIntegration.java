...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.sohclick.hrps.notification.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.sohclick.hrps.notification.security.DomainUserDetailsService", "createSpringSecurityUser");
